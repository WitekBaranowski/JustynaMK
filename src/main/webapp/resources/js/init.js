...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: 'resources/css/style.css', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			...
			'narrow': { range: '-1280', href: 'resources/css/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: 'resources/css/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: 'resources/css/style-mobile.css', grid: { gutters: 20 } },
